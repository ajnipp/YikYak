...
struct Feed {
    ...
    static var example: Feed {
        ...
        [
            ...
            Post(id: 2, community: "UNC", profilePic: "unc-logo", timeString: "3h", image: nil, text: "Why did my parents lie to me and say I'd hav eall this free time in college? this is just a constant grind.", upvotes: 159, comments: 2),
